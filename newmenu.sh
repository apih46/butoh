...
Exp=$(curl -sS https://raw.githubusercontent.com/apih46/butoh/main/skkkk | grep $MYIP | awk '{print $3}')

chck_b(){
	PID=`ps -ef |grep -v grep | grep lukavpn_bot |awk '{print $2}'`
	if [[ ! -z "${PID}" ]]; then
...
curl -sS https://raw.githubusercontent.com/apih46/butoh/main/clgshow
echo -e "
"
fi
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
