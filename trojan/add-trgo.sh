...
linktrgo="trojan-go://${uuidR}@${domain}:${trgo}/?sni=${domain}&type=ws&host=${domain}&path=/lukavpn&encryption=none#${user}"
clear
...
echo -e "Path : /lukavpn" | tee -a /etc/log-create-user.log
