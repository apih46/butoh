...
commonname=None
email=github@lukavpn

# simple password minimal
curl -sS https://raw.githubusercontent.com/apih46/butoh/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:lukavpn07gg -pbkdf2 > /etc/pam.d/common-password
...
echo "telegram.com/lukavpn" > /home/vps/public_html/index.html
# install badvpn
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/apih46/butoh/main/ssh/newudpgw"
...
# install squid
cd
curl -sS "https://raw.githubusercontent.com/apih46/butoh/main/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:lukavpn07gg -pbkdf2 > /etc/squid/squid.conf
...
wget -q https://raw.githubusercontent.com/apih46/butoh/main/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/apih46/butoh/main/banner/issue.net"
