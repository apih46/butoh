...
curl -sS "https://raw.githubusercontent.com/ahmednajmudeen/tetbot/main/sstp/accel.conf" | openssl aes-256-cbc -d -a -pass pass:lukavpn07gg -pbkdf2 > /etc/accel-ppp.conf
